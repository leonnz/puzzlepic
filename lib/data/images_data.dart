class Images {
  static List<Map<String, dynamic>> imageList = <Map<String, dynamic>>[
    ...
    <String, dynamic>{
      ...
      'categoryReadableName': 'Famous Landmarks',
      'categoryImages': <Map<String, String>>[
        <String, String>{
          'assetName': 'big_ben',
    ...
    <String, dynamic>{
      ...
      'categoryImages': <Map<String, String>>[
        <String, String>{
          ...
          'readableFullname': 'Baobab Alley',
          'title': 'Alley of the Baobab trees in Madagascar',
        },
        <String, String>{
          'assetName': 'grand_canyon',
          'readableName': 'The Grand Canyon',
          'readableFullname': 'The Grand Canyon',
          'title': 'Grand Canyon National Park in Arizona, USA',
        },
        <String, String>{
          'assetName': 'highlands',
          'readableName': 'Scottish Highlands',
          'readableFullname': 'Scottish Highlands',
          'title': 'Autumn in the Scottish Highlands, Scotland',
        },
        <String, String>{
          'assetName': 'lake_tahoe',
          'readableName': 'Lake Tahoe',
          'readableFullname': 'Lake Tahoe',
          'title': 'Shoreline sunset at Lake Tahoe in Nevada, USA',
        },
        <String, String>{
          'assetName': 'monument_valley',
          'readableName': 'Monument Valley',
          'readableFullname': 'Monument Valley',
          'title': 'Rock formations in Monument Valley, Colorado, USA',
        },
        <String, String>{
          'assetName': 'moraine_lake',
          'readableName': 'Moraine Lake',
          'readableFullname': 'Moraine Lake',
          'title': 'Moraine Lake and the Rocky Mountains in Canada',
        },
        <String, String>{
          'assetName': 'piedmont',
          'readableName': 'Piedmont',
          'readableFullname': 'Piedmont',
          'title': 'Vineyards in Piedmont region, Nothern Italy',
        },
        <String, String>{
          'assetName': 'plitvice',
          'readableName': 'Plitvice',
          'readableFullname': 'Plitvice Lakes',
          'title': 'Waterfalls at Plitvice Lakes National Park, Croatia',
        },
        <String, String>{
          'assetName': 'rice_fields',
          'readableName': 'Mu Cang Chai',
          'readableFullname': 'Mu Cang Chai',
          'title': 'Terraced rice fields in Mu Cang Chai district, Vietnam',
        },
        <String, String>{
        ...
        <String, String>{
          ...
          'readableFullname': 'Wulingyuan',
          'title': 'Sandstone pillars in Wulingyuan Scenic Area, Hunan Province, China',
        },
        <String, String>{
          'assetName': 'yellowstone',
          'readableName': 'Yellowstone',
          'readableFullname': 'Yellowstone',
          'title': 'The Grand Prismatic Spring in Yellowstone National Park, USA',
        },
      ],
    },
    // Under the Sea
